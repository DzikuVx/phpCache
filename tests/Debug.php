...
class Debug  {
	...
	static protected function formatErrorText($errno, $errstr, $errfile, $errline) {
		...
		$retVal = self::$errorType [$errno] . ': ' . $errstr . "\n";
		$retVal .= 'File: ' . $errfile . "\n";
		$retVal .= 'Line: ' . $errline . "\n";
	...
	static protected function formatExceptionMessage(\Exception $exception) {
		...
		$errorFullText = 'New ' . get_class ( $exception ) . "\n";
		$errorFullText .= 'File: ' . $exception->getFile () . "\n";
		$errorFullText .= 'Line: ' . $exception->getLine () . "\n";
		$errorFullText .= 'Message: ' . $exception->getMessage () . "\n";
		...
		foreach ( $trace as $tTraceItem ) {
			...
			$traceString .= basename ( $tTraceItem ['file'] ) . " at line #" . $tTraceItem ['line'] . "\t";
